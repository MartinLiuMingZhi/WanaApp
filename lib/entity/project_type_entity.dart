...
ProjectTypeEntity projectTypeEntityFromJson(String str) => ProjectTypeEntity.fromJson(json.decode(str));

String projectTypeEntityToJson(ProjectTypeEntity data) => json.encode(data.toJson());
...
class ProjectTypeEntity {
    ...
    factory ProjectTypeEntity.fromJson(Map<dynamic, dynamic> json) => ProjectTypeEntity(
