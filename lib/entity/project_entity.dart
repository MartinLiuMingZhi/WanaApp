...
class ProjectEntity {
    ...
    factory ProjectEntity.fromJson(Map<dynamic, dynamic> json) => ProjectEntity(
        data: ProjectEntityData.fromJson(json["data"]),
...
class ProjectEntityData {
    ...
    factory ProjectEntityData.fromJson(Map<dynamic, dynamic> json) => ProjectEntityData(
        over: json["over"],
